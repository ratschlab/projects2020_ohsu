...
PWD='/cluster/home/myurchikova/github/projects2020_ohsu/eth/learning_Master_thesis/TASKS'

# This directory use for save files like (data, plots, tables and etc.)
SAVE_DIR = '/cluster/work/grlab/projects/projects2020_OHSU/peptides_generation/202301_myurchikova_MT'
...
COLORS_COOR = {
            'size_eth\ohsu':'#529e41',
            'size_intersection':'#ee8538',
            'size_ohsu\eth':'#3c75b1',
            'size_eth\ohsu_coor':(0.8,0.1,0.15),
            'size_intersection_coor':'#ebac23' ,
            'size_ohsu\eth_coor':'#6022F5'
    }
