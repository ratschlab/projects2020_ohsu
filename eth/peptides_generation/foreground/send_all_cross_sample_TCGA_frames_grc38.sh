...
coding_genes=${basedir}/gene_lists/OHSU_gencodev32_proteincodinggeneids.txt
...
uniprot_kmers="/cluster/work/grlab_shared/TMP/prelotla/uniprot/9mers_uniprot-human-UP000005640_9606.tsv" #TODO change
heter_code='0'
kmer='9'
...
for sample_type in TCGA_Ovarian_374 ; do #TCGA_Ovarian_374; do #TCGA_Breast_1102 TCGA_Ovarian_374; do # TCGA_All_Normals TCGA_Ovarian_374 TCGA_Breast_1102; do 
