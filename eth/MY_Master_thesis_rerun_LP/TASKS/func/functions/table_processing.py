...
def sort_filters(df, order_background, order_foreground):#LP
    ...
    df['filter_foreground_target']  = [i[0] for i in df['filter'].values]
    df['filter_foreground_reads'] =  [i[1] for i in df['filter'].values]
    df['filter_foreground_samples'] = [i[2] for i in df['filter'].values]
    df['filter_background_reads'] = [i[3] for i in df['filter'].values]
    df['filter_background_samples'] = [i[4] for i in df['filter'].values]
